...
publicationsCtrl.getSummaryOfPublications = async (req, res) => {
  try {
    ...
    logger.info(
      "The publications required by the user have been successfully retrieved"
    );
...
publicationsCtrl.getPublication = async (req, res) => {
  try {
    ...
    if (!publicationId) throw "Incomplate data";
    ...
    logger.info(
      "The publication required by the user has been successfully retrieved"
    );
